...
class LabelStudioDataConverter(object):
    ...
    def convert_utc_examples(self, raw_examples):
        ...
        for example in raw_examples:
            raw_text = example["data"].split(self.text_separator)
            if len(raw_text) < 1:
                continue
            elif len(raw_text) == 1:
                raw_text.append("")
            ...
            # breakpoint()
            if example["label"]:
                for raw_label in example["label"]:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--label_studio_file", default="./labelstudio_data/clean_data.json", type=str, help="The annotation file exported from label studio platform.")
    parser.add_argument("--save_dir", default="./clean_data", type=str, help="The path of data that you wanna save.")
