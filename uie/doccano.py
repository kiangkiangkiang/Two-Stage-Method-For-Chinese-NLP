...
if __name__ == "__main__":
    ...
    parser.add_argument("--splits", default=[0.9, 0.1, 0], type=float, nargs="*", help="The ratio of samples in datasets. [0.6, 0.2, 0.2] means 60% samples used for training, 20% for evaluation and 20% for test.")
